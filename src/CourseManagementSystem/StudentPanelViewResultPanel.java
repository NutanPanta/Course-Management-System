...
public class StudentPanelViewResultPanel extends JPanel implements AppLayout {
    private JTextField studentLabel, studentName, studentLevelLabel, studentLevel, enrolledCourseLabel, courseName,
            subjectOneObtainedMarks, subjectTwoObtainedMarks, subjectThreeObtainedMarks, subjectFourObtainedMarks,
            subjectFiveObtainedMarks, subjectSixObtainedMarks, subjectSevenObtainedMarks, subjectEightObtainedMarks,
            subjectOneFullMarks, subjectTwoFullMarks, subjectThreeFullMarks, subjectFourFullMarks, subjectFiveFullMarks,
            subjectSixFullMarks, subjectSevenFullMarks, subjectEightFullMarks,
            subjectOnePassMarks, subjectTwoPassMarks, subjectThreePassMarks, subjectFourPassMarks, subjectFivePassMarks,
            subjectSixPassMarks, subjectSevenPassMarks, subjectEightPassMarks,
            subjectOneGrade, subjectTwoGrade, subjectThreeGrade, subjectFourGrade, subjectFiveGrade, subjectSixGrade,
            subjectSevenGrade, subjectEightGrade,
            subjectOneStatus, subjectTwoStatus, subjectThreeStatus, subjectFourStatus, subjectFiveStatus,
            subjectSixStatus, subjectSevenStatus, subjectEightStatus,
            subjectOneModuleName, subjectTwoModuleName, subjectThreeModuleName, subjectFourModuleName,
            subjectFiveModuleName, subjectSixModuleName, subjectSevenModuleName, subjectEightModuleName,
    ...
    private GridBagConstraints gridLayout, details, markSheet;
    ...
    private void clear() {
        clearCompulsory(subjectOneModuleName, subjectTwoModuleName, subjectThreeModuleName, subjectFourModuleName,
                subjectOneObtainedMarks, subjectTwoObtainedMarks, subjectThreeObtainedMarks, subjectFourObtainedMarks,
                subjectOnePassMarks, subjectTwoPassMarks, subjectThreePassMarks, subjectFourPassMarks);

        clearCompulsory(subjectOneFullMarks, subjectTwoFullMarks, subjectThreeFullMarks, subjectFourFullMarks,
                subjectOneGrade, subjectTwoGrade, subjectThreeGrade, subjectFourGrade, subjectOneStatus,
                subjectTwoStatus, subjectThreeStatus, subjectFourStatus);
    }

    private void clearCompulsory(JTextField subjectOneModuleName, JTextField subjectTwoModuleName,
            JTextField subjectThreeModuleName, JTextField subjectFourModuleName, JTextField subjectOneObtainedMarks,
            JTextField subjectTwoObtainedMarks, JTextField subjectThreeObtainedMarks,
            JTextField subjectFourObtainedMarks, JTextField subjectOnePassMarks, JTextField subjectTwoPassMarks,
            JTextField subjectThreePassMarks, JTextField subjectFourPassMarks) {
        clearElective(subjectOneModuleName, subjectTwoModuleName, subjectThreeModuleName, subjectFourModuleName,
                subjectOneObtainedMarks, subjectTwoObtainedMarks, subjectThreeObtainedMarks, subjectFourObtainedMarks,
                subjectOnePassMarks, subjectTwoPassMarks, subjectThreePassMarks, subjectFourPassMarks);
    }

    private void clear1() {
        clearElective(subjectFiveModuleName, subjectSixModuleName, subjectSevenModuleName, subjectEightModuleName,
                subjectFiveObtainedMarks, subjectSixObtainedMarks, subjectSevenObtainedMarks, subjectEightObtainedMarks,
                subjectFivePassMarks, subjectSixPassMarks, subjectSevenPassMarks, subjectEightPassMarks);

        clearElective(subjectFiveFullMarks, subjectSixFullMarks, subjectSevenFullMarks, subjectEightFullMarks,
                subjectFiveGrade, subjectSixGrade, subjectSevenGrade, subjectEightGrade, subjectFiveStatus,
                subjectSixStatus, subjectSevenStatus, subjectEightStatus);

    }

    private void clearElective(JTextField subjectFiveModuleName, JTextField subjectSixModuleName,
            JTextField subjectSevenModuleName, JTextField subjectEightModuleName, JTextField subjectFiveObtainedMarks,
            JTextField subjectSixObtainedMarks, JTextField subjectSevenObtainedMarks,
            JTextField subjectEightObtainedMarks, JTextField subjectFivePassMarks, JTextField subjectSixPassMarks,
            JTextField subjectSevenPassMarks, JTextField subjectEightPassMarks) {
    ...
    public JPanel panelUI() {
        ...
        gridLayout.gridx = 0;
        gridLayout.gridy = 2;
        add(studentPanelStudentReportCard(), gridLayout);
